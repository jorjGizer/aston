...
//public String getAddressById(@PathParam("addressId") Long id) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String getAddressById(@PathVariable("addressId") Long id) {
        try {
...
//public String deleteAddress(@PathParam(value = "addressId") Long id) {?
    ...
    public String deleteAddress(@PathVariable(value = "addressId") Long id) {
        try {
            Address address = dao.findById(id);
            if (address!=null) {
                dao.deleteById(id);
...
//    @Path("{addressId}")
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String updateAddress(@PathVariable(value = "addressId") String addressId,
