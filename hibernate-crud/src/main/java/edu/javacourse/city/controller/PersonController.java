...
//public String getPersonById(@PathParam("personId") Long id) {
    ...
    public String getPersonById(@PathVariable("personId") Long id) {
        try {
...
//    public String updatePerson(@PathParam(value = "personId") Long id,
    @PutMapping(value = "/{personId}", consumes = MediaType.APPLICATION_JSON)
public String updatePerson(@PathVariable(value = "personId") Long id,
